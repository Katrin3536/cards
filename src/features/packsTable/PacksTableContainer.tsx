            ...
            <Box className={style.container}>
                <Grid container justifyContent="center" spacing={1}>
                    <Grid item xs={2} className={style.leftSide}>
                        ...
                        <Button variant="contained" size={'small'} onClick={() => setListType(ListType.All)}>
                            all
                        </Button>
                    </Grid>
                    ...
                    <Grid item xs={10} className={style.rightSide}>
                        ...
                        <PacksTable rowsPerPage={rowsPerPage} setRowsPerPage={setRowsPerPage} listType={listType}/>
                    </Grid>
                </Grid>
            </Box>
        </>
